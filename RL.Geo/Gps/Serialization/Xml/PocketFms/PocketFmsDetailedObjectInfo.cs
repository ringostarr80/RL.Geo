...
namespace RL.Geo.Gps.Serialization.Xml.PocketFms
{
    ...
    public class PocketFmsDetailedObjectInfo
    {
        ...
        [XmlArray(Form = XmlSchemaForm.Unqualified), XmlArrayItem("COMM", Form = XmlSchemaForm.Unqualified, IsNullable = false)]
        public PocketFmsComm[] Communications { get; set; }

        [XmlArray(Form = XmlSchemaForm.Unqualified), XmlArrayItem("Remark", Form = XmlSchemaForm.Unqualified, IsNullable = false)]
